-- Phantom Speed Booster (Obfuscated Loadstring)
-- Execute this in your executor

loadstring(game:HttpGet("https://pastebin.com/raw/YOURPASTE"))()

--[[ OR use the direct loadstring below ]]

loadstring([=[
-- Fixed version with proper variable declarations
...
frame.Position=UDim2.new(.5,-140,.5,-90)
...
gradient.Color=ColorSequence.new{ColorSequenceKeypoint.new(0,Color3.fromRGB(20,30,60)),ColorSequenceKeypoint.new(1,Color3.fromRGB(10,20,40))}
...
input.Size=UDim2.new(.85,0,0,40)
input.Position=UDim2.new(.075,0,0,60)
...
button.Size=UDim2.new(.85,0,0,45)
button.Position=UDim2.new(.075,0,0,115)
